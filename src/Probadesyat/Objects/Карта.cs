...
namespace IIS.Probadesyat
{
    ...
    public class Карта : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadesyat.ВидКарты fТипКарты;
        ...
        [NotNull()]
        public virtual IIS.Probadesyat.ВидКарты ТипКарты
        {
            get
            {
                ...
                IIS.Probadesyat.ВидКарты result = this.fТипКарты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаE", typeof(IIS.Probadesyat.Карта));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаL", typeof(IIS.Probadesyat.Карта));
                }
            }
        }
    }
