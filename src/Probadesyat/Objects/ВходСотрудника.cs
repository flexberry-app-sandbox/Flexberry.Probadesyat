...
namespace IIS.Probadesyat
{
    ...
    public class ВходСотрудника : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadesyat.Сотрудник fСотрудник;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Probadesyat.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Probadesyat.Сотрудник result = this.fСотрудник;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВходСотрудникаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВходСотрудникаE", typeof(IIS.Probadesyat.ВходСотрудника));
                }
            }
        }
    }
    ...
    public class DetailArrayOfВходСотрудника : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Probadesyat.DetailArrayOfВходСотрудника members)

        // *** End programmer edit section *** (IIS.Probadesyat.DetailArrayOfВходСотрудника members)
        ...
        /// </summary>
        public DetailArrayOfВходСотрудника(IIS.Probadesyat.РегистрВхода fРегистрВхода) : 
                base(typeof(ВходСотрудника), ((ICSSoft.STORMNET.DataObject)(fРегистрВхода)))
        {
        }
        
        public IIS.Probadesyat.ВходСотрудника this[int index]
        {
            get
            {
                return ((IIS.Probadesyat.ВходСотрудника)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Probadesyat.ВходСотрудника dataobject)
        {
